...
type Row = { id: number; name: string; email: string; role: UserRole };
...
const AdminUsersPage = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Typography variant="h4" sx={{ fontWeight: 700, mb: 3 }}>Quản lý người dùng</Typography>
      <Table>
        <TableHead>
          <TableRow>
              ...
              <TableRow key={u.id}>
                ...
                <TableCell align="right">
                  <IconButton
                    title="Đổi vai trò"
                    disabled={isSelf}
                    onClick={async () => { await userApi.updateRole(u.id, u.role === "admin" ? "customer" : "admin"); loadUsers(); }}
                  >
                    <SwapHorizIcon />
                  </IconButton>
                  <IconButton
